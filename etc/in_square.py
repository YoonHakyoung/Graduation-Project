...
# 두 노드의 좌표값을 지도에 표시
folium.Marker(location=n1, tooltip='Node 1', icon=folium.Icon(color='pink')).add_to(m)
folium.Marker(location=n2, tooltip='Node 2', icon=folium.Icon(color='pink')).add_to(m)
